export default function ProjectCard({ project }) {
    return (
        <div className="border border-[#636B2F] rounded-xl p-5 bg-[#3D4127] hover:shadow-lg hover:shadow-[#636B2F]/30 transition">
        ...
        <div className="flex gap-3 text-sm text-[#D4DE95] mb-3 underline">
